(function(){
  ...
  const typeLabels={person:'People',hearing:'Hearings',organization:'Organizations',document:'Documents',topic:'Topics',case:'Cases',interview:'Media',podcast_episode:'Media',legislation:'Legislation',timeline_event:'Timeline',publication:'Publications',program:'Programs',research_project:'Research Projects',advisory_panel:'Advisory Panels',facility:'Facilities',military_vessel:'Military Vessels',military_unit:'Military Units',claim:'Claims',podcast_series:'Podcast Series'};
  const icons={person:'👤',hearing:'🏛️',organization:'🏢',document:'📄',topic:'🧭',case:'🛸',interview:'🎙️',podcast_episode:'🎙️',legislation:'📜',timeline_event:'🕒',publication:'📰',program:'📋',research_project:'🔬',advisory_panel:'🧪',facility:'📍',military_vessel:'⚓',military_unit:'🎖️',claim:'⚖️',podcast_series:'🎙️'};
