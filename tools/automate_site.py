...
STEPS=['build_graph.py','build_timeline_normalization.py','build_podcasts.py','build_related_content.py','build_entity_pages.py','build_development_updates.py','build_homepage.py','build_sitemap.py','validate_graph.py','validate_podcasts.py','validate_rendering_rules.py','validate_timeline_normalization.py','validate_sources.py','validate_visual_identity.py','validate_research_accelerator.py','build_deployment_report.py']
def main():
